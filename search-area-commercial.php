...
<div class="row">
    ...
    <div class="col-md-4 input_holder">
        ...
        <span class="form_input"><input type="text" class="form-control" id="nomB2C" placeholder=""></span>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-4 input_holder">
        ...
        <span class="form_input"><input type="text" class="form-control" id="sireneB2B" placeholder=""></span>
        </div>
    </div>

    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="RaisonSocialeB2B">Raison Sociale B2B</label></span>
        <span class="form_input"><input type="text" class="form-control" id="raisonSocialeB2B" placeholder=""></span>
        </div>
    </div>

    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="ChargeAffaireB2B">Charge Affaire B2B</label></span>
        <span class="form_input"><input type="text" class="form-control" id="chargeAffaireB2B" placeholder=""></span>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="ChargeAffairePro">Charge Affaire Pro</label></span>
        <span class="form_input"><input type="text" class="form-control" id="chargeAffairePro" placeholder=""></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="ApporteurAffaireNom">Apporteur Affaire Nom</label></span>
        <span class="form_input"><input type="text" class="form-control" id="apporteurAffaireNom" placeholder=""></span>
        </div>
    </div>

    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="ApporteurAffaireSiren">Apporteur Affaire Siren</label></span>
        <span class="form_input"><input type="text" class="form-control" id="apporteurAffaireSiren" placeholder=""></span>
        </div>
    </div>

    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="PrestataireNom">Prestataire Nom</label></span>
        <span class="form_input"><input type="text" class="form-control" id="prestataireNom" placeholder=""></span>
        </div>
    </div>
</div>
...
<div class="row search_last_row">
    <div class="col-md-4 input_holder">
        <div class="form-group">
        <span class="form_label"><label for="PrestataireSiren">Prestataire Siren</label></span>
        <span class="form_input"><input type="text" class="form-control" id="prestataireSiren" placeholder=""></span>
        </div>
    </div>
