...
<div class="panel-heading">
  <h4 class="panel-title">
    <span class="panel_header_element"><a data-toggle="collapse" href="#collapseListeDossiers">Listes Dossiers - Dossiers En Cours</a></span>
    <span class="panel_header_element"><a data-toggle="collapse" href="#collapseListeDossiers"><i class="glyphicon glyphicon-file"></i></a></span>
  </h4>
</div>
...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-md-12 data_table_holder">
            <table id="listeDossiers" class="table table-striped table-bordered nowrap" style="width:100%">
            <thead>
            <tr>
                <th>Num Dossier</th>
                <th>Total</th>
