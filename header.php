									...
									<div class="fieldset-container">
                                        ...
                                        ?>
        									<li><a href="/uiportailcee?pageLoaded=Dossiers&id=<?=$i ?>"> <span
        													class="form_label"><label for="numDossiers">&#x2116;
        															Dossiers</label></span> <span class="descriptAlerte">45678102</span>
        													<span class="form_label"><label for="nature-piece">Statut
        															de la pièce</label></span> <span class="descriptAlerte">En
        														attente</span> <span class="form_label"><label
        														for="nature-piece">Nature de la pièce</label></span> <span
        													class="descriptAlerte">Bon de commandes test here also</span>
        									...
        									<li><a href="/uiportailcee?pageLoaded=Dossiers&id=<?=$i ?>"> <span
        													class="form_label"><label for="numDossiers">&#x2116;
        															Dossiers</label></span> <span class="descriptAlerte">321548836</span>
        													<span class="form_label"><label for="nature-piece">Statut
        															de la pièce</label></span> <span class="descriptAlerte">Rejeté</span>
        
        													<span class="form_label"><label for="statut">Raison
        															d'inégibilité</label></span> <span class="descriptAlerte">Bon
        														de commandes test here also</span>
