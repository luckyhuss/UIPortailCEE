		...
		<div class="panel-heading">
			<h4 class="panel-title">
				<span class="panel_header_element"><a data-toggle="collapse"
					href="#gestUtilisateurGigya">Gestion Utilisateur Gigya</a></span> <span
					class="panel_header_element"><a data-toggle="collapse"
					href="#gestUtilisateurGigya"><i class="glyphicon glyphicon-user"></i></a></span>
			</h4>
		</div>
...
<div class="panel-group displayed" id="add-edit-panel">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<span class="panel_header_element"><a data-toggle="collapse"
					href="#gestAddEditUtilisateurGigya">Ajouter/Modifier Gigya</a></span>
				<span class="panel_header_element"><a data-toggle="collapse"
					href="#gestAddEditUtilisateurGigya"><i
						class="glyphicon glyphicon-user"></i></a></span>
			</h4>
		</div>

		<div id="gestAddEditUtilisateurGigya"
...
function displayDetailUser(id) {
	...
	$("html,body").animate({scrollTop: $("#gestAddEditUtilisateurGigya").offset().top}, 2000);
}
