...
<table id="resultatRecherche" class="table table-striped table-bordered nowrap" style="width:100%">
        <thead>
            <tr>
                <th>Num Dossier</th>
                <th>Num Action</th>
        ...
        <tbody>
            <tr>
                ...
                <td>10.00</td>
                <td>500.23</td>
                <td><a href="#"><i class="glyphicon glyphicon-eye-open"  data-toggle="collapse" data-target="#collapseDetailDossier"></i></a></td>
            </tr>
            <tr>
                <td>23762328</td>
                <td>23762328</td>
...
<div class="panel-heading">
  <h4 class="panel-title">
    <span class="panel_header_element"><a data-toggle="collapse" href="#collapseDetailDossier">Detail Du Dossier</a></span>
    <span class="panel_header_element"><a data-toggle="collapse" href="#collapseDetailDossier"><i class="glyphicon glyphicon-sort"></i></a></span>
  </h4>
</div>
...
<div class="detailDossier">
        ...
        <table id="detailDossierOperations" class="table table-striped table-bordered nowrap" style="width:100%">
        ...
        <tbody>
            <tr>
                ...
                <td>10</td>
                <td>500</td>
                <td><a href="#"><i class="glyphicon glyphicon-eye-open"  data-toggle="modal" data-target="#Modal1"></i></a></td>
            </tr>
            <tr>
                <td>Dossier 2</td>
                <td>Fiche 2</td>
    ...
    <!-- Info Beneficiaire -->
        ...
        <table id="infoBeneficiaire" class="table table-striped table-bordered nowrap" style="width:100%">
