			...
			<fieldset class="resultatCumulerPanel">
				...
				<div class="fieldset-container">
					...
					<div class="repartition-section col-md-4">
						...
						<div class="col-sm-6 col-md-12 input_holder">
							<div class="header-group">
								<span class="header_label"><label for="ResultatCumuleAAHP_aide"> Hors précarité</label></span>
								<span class="header_output" id="resultatCumuleAAHPAide_OP0">10 kWhc</span>
							</div>
						</div>

						<div class="col-sm-6 col-md-12 input_holder">
							<div class="header-group">
								<span class="header_label"><label for="ResultatCumuleAAP_aide"> Précarité</label></span>
								<span class="header_output" id="resultatCumuleAAPAide_OP0">10 kWhc</span>
							</div>
						</div>
					</div>
